...
import { Heart, Shield, Activity, Users, Database, Smartphone, ArrowRight, TrendingUp, Zap, Server, ShieldCheck, Cpu, Gauge, Clock, RefreshCw, Layers, BarChart, ShoppingCart, MapPin, Tablet } from "lucide-react"; 
...
const Healthcare = () => {
    ...
    // 🚨 NEW MODULES: Reflecting Manufacturers <--> Clinics/Practices Middleware Role
    const solutions = [
        {
            icon: Layers,
            title: "Seamless Integration Hub",
            description: "Comprehensive tools for Manufacturers to manage products/orders and Practices to manage providers/orders.",
        },
        {
            icon: BarChart,
            title: "Advanced Analytics",
            description: "Track revenue trends, market share analysis, and customer retention with real-time dashboards.",
        },
        {
            icon: ShoppingCart,
            title: "Smart Inventory Management",
            description: "AI-powered inventory control with color-coded alerts, automated reordering, and category filtering.",
        },
        {
            icon: MapPin,
            title: "Provider Network Management",
            description: "Comprehensive relationship management including satisfaction tracking and contract renewals.",
        },
        {
            icon: Tablet,
            title: "Patient Eligibility (IVR)",
            description: "Quick eligibility checks via IVR directly embedded in the system for fast, compliant ordering.",
        },
        {
            icon: ShieldCheck,
            title: "Enterprise Security",
            description: "Bank-level encryption, HIPAA compliance, and SOC 2 certification for complete data protection.",
        },
    ];

    // Data for the Success Metrics section
    ...
    // New data structure for Core Features
    const outcomes = [
    ...
    // Using local imports for gallery images
    const galleryImages = [
        { src: m1, title: "Manufacturer Order Management", description: "Tracking product lines and fulfillment status." },
        ...
        { src: m5, title: "Provider Performance Metrics", description: "Analytics dashboard for contract and satisfaction scores." },
        { src: m6, title: "Eligibility Check Interface", description: "IVR and system interface for patient eligibility verification." },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10 py-32">
                    <div className="max-w-4xl mx-auto text-center space-y-6">
                        <h1 className="text-5xl md:text-6xl font-bold text-foreground opacity-0 animate-[fadeInUp_0.8s_ease-out_0.1s_forwards]">
                           <span className="text-primary">MedIntel :</span> Transform Your manufacturers and Practice Integration
                        </h1>
                        <p className="text-xl text-muted-foreground opacity-0 animate-[fadeInUp_0.8s_ease-out_0.3s_forwards]">
                            The vital middleware connecting clinics, medical centers, and equipment manufacturers for seamless ordering, logistics, and compliance.
                        </p>
                    </div>
                </div>
            </section>

            {/* Clinical Outcomes & Compliance Section (MIDDLEWARE VALUE PROPOSITION) */}
            <section className="py-24 bg-background">
                <div className="container mx-auto px-4 lg:px-8">
                    {/* --- Order Fulfillment & Production Efficiency --- */}
                    <div className="max-w-6xl mx-auto space-y-8 p-8 md:p-12 border border-primary/30 rounded-xl shadow-2xl shadow-primary/10 bg-card mb-16 animate-on-scroll">
                        ...
                        {/* Content Area - Text and Cards */}
                        <div className="grid md:grid-cols-2 gap-8 items-start mb-8">
                            {/* Left: Outcomes Cards (Slide-In from Left) */}
                            <div className="space-y-6">
                                {outcomes.map((item, index) => (
                                    <div 
                                        key={index} 
                                        // Motion: Staggered Slide-In from Left
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-lg text-muted-foreground leading-relaxed">
                                    MedIntel acts as the **central hub** where clinical center workers and medical merchants can directly place equipment and supply orders to manufacturers. This cuts out unnecessary layers, speeds up delivery, and provides manufacturers with accurate, real-time demand signals.
                                </p>
                            </div>
                        </div>

                        {/* Full-Width Image Section - respects parent padding */}
                        <div 
                            className="w-full aspect-video overflow-hidden shadow-xl border border-border/50 rounded-lg mt-8"
                        >
                            <img 
                                src={galleryImages[0].src} // Virtual Care Interface image (m1)
                    ...
                    <div className="max-w-6xl mx-auto space-y-8 p-8 md:p-12 border border-primary/30 rounded-xl shadow-2xl shadow-primary/10 bg-card animate-on-scroll">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 items-start">
                            {/* Left: Compliance Cards (Slide-In from Right, md:order-first) */}
                            <div className="space-y-6 md:order-first">
                                {compliance.map((item, index) => (
                                    <div 
                                        key={index} 
                                        // Motion: Staggered Slide-In from Right
                                        className="flex items-start space-x-4 p-4 bg-background rounded-lg shadow-md animate-on-scroll opacity-0 translate-x-10 transition-all duration-700"
                                        style={{ transitionDelay: `${index * 150}ms` }}
                                    >
                                        <item.icon className="h-6 w-6 text-primary flex-shrink-0 mt-1" />
                            ...
                            {/* Right: Text and Image Box (md:order-last) */}
                            <div className="space-y-6 md:order-last">
                                ...
                                <p className="text-lg text-muted-foreground leading-relaxed">
                                    MidIntel delivers a fully governed, audit-ready data environment that connects manufacturers and clinics securely, ensuring every order and transaction maintains **complete data protection and regulatory compliance**.
                                </p>
                                <div className="aspect-video rounded-lg overflow-hidden shadow-xl border border-border/50">
                                    <img 
                                        src={galleryImages[3].src} // Data Security Architecture image (m4)
            ...
            {/* --- NEW SECTION 1: MedIntel Success Metrics --- */}
            <section className="py-24 bg-background">
                <div className="container mx-auto px-4 lg:px-8">
            ...
            {/* Solutions Grid - MedIntel Core Modules (Slide Up) */}
            <section className="py-24 bg-card">
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16 animate-on-scroll">
                        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-card-foreground">MedIntel Features</h2>
                        <p className="text-xl text-muted-foreground">
            ...
            {/* Healthcare Image Gallery Section */}
            <section className="py-24 bg-background">
            ...
            {/* --- NEW SECTION 2: Start Your Transformation CTA --- */}
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center space-y-4 animate-on-scroll">
                        ...
                        <p className="text-lg text-muted-foreground">
                            Integrate MedIntel today and start benefiting from intelligent supply chain management.
                        </p>
                    </div>
                </div>
            </section>

            {/* Main CTA Section - Themed and Image Background */}
            <section 
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    <div className="max-w-3xl mx-auto text-center space-y-8 animate-on-scroll">
                        <h2 className="text-4xl md:text-5xl font-bold text-foreground">
                            Ready to Implement MedIntel for Manufacturers
                        </h2>
                        <p className="text-xl text-muted-foreground">
                            Schedule a free Manufacturers assessment and demo of the MedIntel platform.
                        </p>
                        <Link to="/contact">
